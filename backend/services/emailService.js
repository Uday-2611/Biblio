...
export const sendResetCodeEmail = async (email, resetCode) => {
    try {
        const mailOptions = {
            ...
            to: email,
            subject: 'Password Reset Code - Biblio',
            html: `
                <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
                    <h2 style="color: #000;">Password Reset Code</h2>
                    <p>You requested a password reset for your Biblio account.</p>
                    ...
                    <p style="color: #666; font-size: 14px; margin-top: 30px;">Biblio - Your Online Bookstore</p>
                </div>
            `
        };
