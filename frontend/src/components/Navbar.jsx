        ...
        <>
            <div className='fixed top-0 left-0 right-0 z-50 bg-[#111] text-white'>
                <div className='flex items-center justify-between px-4 py-3 md:py-4'>
                    <NavLink to='/home'>
                        <h1 className='text-3xl md:text-[2vw] font-[Stardom] font-medium text-red-600 tracking-tight'>
                            Biblio
                        </h1>
                    </NavLink>
                ...
                <div className={`md:hidden transition-all duration-300 ease-in-out overflow-hidden ${isMobileMenuOpen ? 'max-h-40' : 'max-h-0'}`}>
                    <div className='flex flex-col bg-[#111] px-4 pb-4 gap-4'>
                        <NavLink to='/collection' className="text-lg hover:text-neutral-400" onClick={() => setIsMobileMenuOpen(false)} >
                            SHOP
                        </NavLink>
                        <NavLink to='/profile' className="text-lg hover:text-neutral-400" onClick={() => setIsMobileMenuOpen(false)} >
                            PROFILE
                        </NavLink>
                    </div>
                </div>
