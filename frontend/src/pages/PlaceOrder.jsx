  ...
  return (
    <div className='min-h-screen w-full bg-white flex flex-col md:flex-row'>
      ...
      <div className='w-full md:w-[60%] p-4 sm:p-8 md:p-16 flex flex-col gap-8 overflow-y-auto'>
        <h1 className='font-[Editorial] text-red-600 text-4xl sm:text-5xl tracking-tighter'>Biblio</h1>
        ...
        <form onSubmit={onSubmitHandler} className='font-[Monsterat] flex flex-col gap-6 w-full sm:w-[90%] md:w-[80%]'>
          ...
          <div className='flex flex-col sm:flex-row gap-4'>
            <input 
              ...
              className='w-full sm:w-1/2 p-3 sm:p-4 bg-neutral-200' 
            />
          ...
          <input 
            ...
            type="text" 
            placeholder='Address' 
            className='w-full p-3 sm:p-4 bg-neutral-200' 
          />
          ...
          <div className='flex flex-col sm:flex-row gap-4'>
            <input 
              ...
              type="text" 
              placeholder='City' 
              className='w-full sm:w-1/3 p-3 sm:p-4 bg-neutral-200' 
            />
            <input 
              required 
              onChange={onChangeHandler} 
